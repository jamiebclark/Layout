...
class Date {
	...
	public static function validStamp($str) {
		//Already a stamp
		if(ctype_digit($str)) {
			return $str;
		}
	...
	public static function dateArray($yearOrDateString = null, $month = null, $day = null) {
	...
	public static function calendarImage($dateStr = null, $options = array()) {
	...
	public static function dateRangeLimit($start, $end, $adj, $a, $b, $result) {
		if ($result[$a] < $start) {
	...
	public static function secondsString($seconds, $options = array()) {
		$units = array(
			DAY => 'day',
			HOUR => 'hour',
			MINUTE => 'minute',
